...
<form action="<?= site_url(route_to('login')) ?>" method="post">
	...
	<div class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Email o Usuario</label>
		<input type="text" id="loginEmail" maxlength="256" name="login"/>
		<p class="helper helper1"></p>
		<span class="indicator"></span>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="password" id="loginPasswordLabel">Contraseña</label>
    ...
    <?php if ($config->activeResetter) : ?>
        <a style="text-decoration:none" href="<?= site_url(route_to('forgot')) ?>">Olvide mi Contraseña</a>
    <?php endif; ?>
    </div>
    <div class="inputGroup">
    <?php if ($config->allowRegistration) : ?>
        <a style="text-decoration:none" href="<?= site_url(route_to('register')) ?>">Registrarme</a>
    <?php endif; ?>
    </div>
</form>
<script  src="<?= base_url('/assets/login/js/TweenMax.min.js')?>"></script>
<script  src="<?= base_url('/assets/login/js/MorphSVGPlugin.js')?>"></script>
